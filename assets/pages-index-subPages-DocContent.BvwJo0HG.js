import{d as b,r as C,c as h,x as w,y as B,a as i,w as e,b as v,z as D,A as N,f as d,g as a,i as W,B as R,j as V,k as l,t as $,u as A,s as E}from"./index-Bt5U6C3y.js";import{a as L}from"./components.dP1TBvMg.js";const I=b({__name:"DocContent",setup(S){const k=D(),f=N(),p=C(),c=h(()=>{const t=k.params.name;return L.find(s=>s.name===t)}),m=h(()=>c.value?`/uiadmin.net/uview-plus/components/${c.value.path}`:"");function x(){f.push("/")}function _(){try{const t=p.value;if(!(t!=null&&t.contentWindow))return;const s=t.contentDocument||t.contentWindow.document,n=s.createElement("style");n.textContent=`
